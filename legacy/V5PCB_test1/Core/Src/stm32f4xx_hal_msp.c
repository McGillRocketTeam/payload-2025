...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC1     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(xsignal_GPIO_Port, xsignal_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(ysignal_GPIO_Port, ysignal_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3     ------> ADC3_IN13
    */
    HAL_GPIO_DeInit(zsignal_GPIO_Port, zsignal_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, STLINK_UART_TX_Pin|STLINK_UART_RX_Pin);
