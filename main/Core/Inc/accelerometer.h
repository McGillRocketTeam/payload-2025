...
/**
 * @brief Records accelerometer data into the sample buffer and flags the analysis as ready.
 * This function should be called in the ADC conversion half complete/complete callback.
 * @param accel Pointer to the accelerometer handler structure.
 * @param buffer Pointer to the source buffer which the ADCs write to.
 */
bool PL_Accelerometer_Record(PL_Accelerometer_Handler *accel, uint16_t *buffer);
/**
 ...
 * @param accel Pointer to the accelerometer handler structure.
 * @param amplitudes_x Pointer to the output array for X-axis FFT amplitudes.
 * @param amplitudes_y Pointer to the output array for Y-axis FFT amplitudes.
 * @param amplitudes_z Pointer to the output array for Z-axis FFT amplitudes.
 ...
 * @param amplitudes Pointer to the array of FFT amplitudes.
 * @return The peak frequency in Hz.
 */
float PL_Accelerometer_PeakFrequency(float *amplitudes);
